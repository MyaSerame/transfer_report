...
\begin{figure}[H]
    \centering
\includegraphics[width = 7 cm]{nicu_babycam.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 14 cm]{nicu_Output_HR.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_ROI.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 10 cm]{nicu_HR_magresponse.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_PPGi_hr.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 10 cm]{nicu_resampled_hr.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_HR_peaks.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width = 12 cm]{nicu_SQI_vidHR.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width = 12 cm]{nicu_Output_RR.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_RR_magresponse.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_RR_peaks.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width = 12 cm]{nicu_SQI_vidRR.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_HREstimates.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width = 12 cm]{nicu_HR_summary.png}
...
\begin{figure}[H]
\centering
\includegraphics[width = 12 cm]{nicu_RREstimates.png}
...
\begin{figure}[H]
    \centering
\includegraphics[width = 12 cm]{nicu_RR_summary.png}
...
This chapter is relevant to the overall scope of this project to estimate RR because we will be using video-camera input data for analysis of the Kenya pneumonia study. Therefore, the algorithms developed here will form a basis for video camera vital sign estimation going forward.

\begin{center}
\begin{figure}[H]
\centering
\includegraphics[width = 10 cm]{nicu_PPGi_rr.png}
